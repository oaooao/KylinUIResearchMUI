 ...
 */
const TouchRipple = React.forwardRef<any, any>(function TouchRipple(
  inProps,
  ref
) {
  const props = useThemeProps({ props: inProps, name: "KylinUITouchRipple" });
  ...
  const startTimer = React.useRef<number>(null);
