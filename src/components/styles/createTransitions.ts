...
import { Duration, Easing, Transitions, TransitionsOptions } from "./types/transitions";
...
export default function createTransitions(inputTransitions: TransitionsOptions): Transitions {
  ...
  const create: Transitions['create'] = (props = ['all'], options: Partial<{ duration: number | string; easing: string; delay: number | string }> = {}) => {
    const {
